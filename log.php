...
class Log extends Dbconfig {	
    ...
    public function successLog($matricNo, $password){
        ...
        // initializing variables for storing the different cases of attempts 
        $login_attempts = 0;
        $successful_logins = 0;
        ...
        //This function was used to get the browser of the client
        $browser = getBrowser();
       ...
       $table_rows = mysqli_num_rows($check_table);
        if($table_rows == 1){
            ...
            mysqli_query($this->dbConnect, "INSERT INTO ".$this->table2." VALUES('$ip_address', '$date', '$info', '$successful_logins', '$failed_login_attempts', $malicious_attempts)");
    ...
    public function failedLog($matricNo, $password){
        ...
        if($table_rows === 1){
            ...
            mysqli_query($this->dbConnect, "INSERT INTO ".$this->table2." VALUES('$ip_address', '$date', '$trimmed_info', '$successful_logins', '$failed_login_attempts', $malicious_attempts)");
