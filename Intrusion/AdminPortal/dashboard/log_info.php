...
$sql = "SELECT * FROM log_infos WHERE client_address = '$client_address'";
...
<head>
  ...
  <title>Log info for user <?php echo $client_address; ?></title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><a href="student-log.php">logs</a></li>
              <li class="breadcrumb-item">user (<?php echo $client_address; ?>) </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo $Row["successful_logins"] ?></td>
                    <td><?php echo $Row["failed_login_attempts"] ?></td>
                    <td><?php echo $Row["malicious_attempts"] ?></td>
                  </tr>
                  <?php 
                    }
                  ?>
