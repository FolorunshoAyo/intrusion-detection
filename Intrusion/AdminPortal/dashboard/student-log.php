...
$sql = "SELECT client_address, browser, date, login_attempts FROM logs";
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    ?>
                  <tr>
                    <td><a href="log_info.php?client_address=<?php echo $Row['client_address']; ?>"><?php echo $Row["client_address"]?></a></td>
                    <td><?php echo $Row["browser"] ?>
                    </td>
